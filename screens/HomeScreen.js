...
class vistaInicio extends React.Component {
      ...
      static navigationOptions = {
            ...
            _onRefresh = () => {
                  fetch('http://10.12.48.109/backend/backend.php', {
                        method: 'POST',
                        headers: {
            ...
            _onDelete = (e) => {
                  fetch('http://10.12.48.109/backend/eliminar.php', {
                        method: 'POST',
                        headers: {
                              'Accept': 'application/json',
                              'Content-Type': 'application/json',
...
export class childComponent extends React.Component {
      ...
      render (){
            return(
                  ...
                  <ImageBackground source={Fondotrabun} style={styles.backgroundContainerPerfil}>
                  <ScrollView>
                  <Card style={styles.tarjetaPerfil}>
                  <Card.Content style={styles.contenidoPerfil}>
                  <Title style={styles.tituloPerfil}>Ingrese sus Datos</Title>
                  <View>
                        ...
                        />
                        <Button style={styles.botonPerfil}>
                              <Text style={styles.textoPerfil}>Enviar</Text>
                        </Button>
...
export class hijoPeril extends React.Component {
      ...
      render (){
            return(
                  <ImageBackground source={Fondotrabun} style={styles.backgroundContainerPerfil}>
                  <ScrollView>
                  <Card style={styles.containerPerfil}>
                  <Title style={styles.tituloPerfil}>GENERAL</Title>
                        <View style={styles.itemPerfil}>
                              <Text style={styles.titulo2Perfil}>ESTEBAN GUERRERO</Text>
                              <Image source={esteban} style ={styles.logoPerfil}></Image>
                              ...
                              <Icon name="user-graduate" color='#4747d1' size={44} style={styles.iconPerfil}/>
                  ...
                  <Card style={styles.containerPerfil}>
                  <Title style={styles.tituloPerfil}>RAMOS MAS DEMANDADOS</Title>
                        <View style={styles.itemPerfil}>
                              <Button
                                    type="button"
                                    onClick={this.handleAddShareholder}
                  ...
                  <Card style={styles.containerPerfil}>
                  <Title style={styles.tituloPerfil}>WEÑISIMA</Title>
                  <View style={styles.itemPerfil}>
                  <Button
                              type="button"
                              onClick={this.handleAddShareholder}
...
class vistaMapa extends React.Component {
      ...
      actualizarPosicion(la, lo){
            ...
            console.log(rut)
            fetch('http://10.12.48.109/backend/modificar.php', {
                  method: 'POST',
                  headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
      ...
      buscarUsuario = () => {
            const { navigation } = this.props;
            const rut = navigation.getParam('rut', 'NO-RUT');
            fetch('http://10.12.48.109/backend/buscar.php', {
                  method: 'POST',
                  headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
...
class vistaAgregar extends React.Component {
      ...
      constructor() {
            ...
            agregar = () => {         
                  fetch('http://10.12.48.109/backend/agregar.php', {
                        method: 'POST',
                        headers: {
                          Accept: 'application/json',
                          'Content-Type': 'application/json',
